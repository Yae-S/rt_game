...
# Import target "main_comp" for configuration "Debug"
SET_PROPERTY(TARGET main_comp APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
SET_TARGET_PROPERTIES(main_comp PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/components/lib/main_comp.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/components/bin/main_comp.dll"
  )
...
# Import target "main_compcomp" for configuration "Debug"
SET_PROPERTY(TARGET main_compcomp APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
SET_TARGET_PROPERTIES(main_compcomp PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/components/bin/main_compcomp.exe"
  )
